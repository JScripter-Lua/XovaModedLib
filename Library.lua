--[[
    ...
    Updated: Auto Scaling, Customizable Theme (Hex + Color3), Customizable Size,
             ...
             Dropdown Title/BG/Stroke color fix -- No CoreGui
--]]
...
-- NewRows now accepts a Theme table (T)
